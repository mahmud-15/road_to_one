...
class AppColors {
  // Primary Color
  static const Color primaryColor = Color(0xFFD1FC5B);

  // Existing Colors
  static const Color secondary = Color(0xff454545);
  static const Color backgroudColor = Color(0xff1C1C1C);
  ...
  static const Color upcolor = Color(0xFF151515);
  static const Color buttonTextColorsHere = Color(0xFF192026);
